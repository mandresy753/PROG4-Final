...
class GradeAuthorizationServiceTest {
  ...
  void canGrade_teacher_assigned() {
    ...
    var exam = com.example.demo.entity.JExam.builder().id(UUID.randomUUID()).courseOffering(courseOffering).build();
    var examSession = com.example.demo.entity.JExamSession.builder().id(examSessionId).exam(exam).build();
    ...
    var assignment = com.example.demo.entity.JTeacherAssignment.builder()
        ...
        .courseOffering(courseOffering).build();
